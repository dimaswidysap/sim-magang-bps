...
@section('content')
    <section class="w-full p-3 md:p-6 font-montserrat">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Header Halaman -->
            <div class="mb-6">
                <h1 class="text-xl md:text-2xl font-bold text-text">Data Mahasiswa Magang</h1>
                <p class="text-xs md:text-sm text-text-light mt-1">Daftar mahasiswa yang sedang menjalankan periode magang
                    aktif.</p>
            </div>
            ...
            <div class="mb-6 border-b border-border overflow-x-auto scrollbar-none">
                <nav class="flex space-x-2 md:space-x-4 min-w-max pb-2">
                    <a href="{{ route('magang-aktif') }}"
                        class="px-4 py-2 text-xs md:text-sm font-semibold rounded-lg bg-primary text-white shadow-sm transition-all">
                        Aktif
                    </a>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-border text-xs md:text-sm">
                            @forelse ($magangAktif as $item)
                                ...
                                <tr class="hover:bg-primary/5 transition-colors duration-150 align-middle">
                                    <!-- Nama & NIM -->
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 rounded-full bg-primary/10 text-primary-dark font-bold flex items-center justify-center shrink-0 border border-primary/20 text-sm">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <span
                                            class="inline-flex items-center gap-1.5 px-3 py-1 bg-success/10 border border-success/20 text-success-dark text-xs font-bold rounded-full">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-text-light">
                                        <p class="text-sm">Belum ada data mahasiswa magang yang aktif saat ini.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
