<section class="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 font-montserrat">
    ...
    <div
        class="bg-surface border border-border rounded-[10px]  p-5 md:p-6 flex items-center gap-4 md:gap-6 hover:shadow-md transition-shadow duration-300">
        ...
        <div class="flex-1">
            ...
            <div class="flex items-end gap-2">
                <h2 class="text-2xl md:text-3xl font-bold text-text leading-none">{{ $jumlahSelesai }}</h2>
    ...
    <div
        ...
        <div class="flex-1">
            ...
            <div class="flex items-end gap-2">
                <h2 class="text-2xl md:text-3xl font-bold text-text leading-none">{{ $jumlahBelumSelesai }}</h2>
