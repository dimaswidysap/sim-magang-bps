...
<header class="w-full flex p-2">
    ...
    <a href="{{ route('mahasiswa-profil') }}"
        ...
        <figure class="h-10 w-10 md:h-11 md:w-11 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 border border-primary/20 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
        ...
        <div class="flex flex-col justify-center">
            <span class="font-bold text-text text-sm leading-tight group-hover:text-primary transition-colors duration-300">
                {{ auth()->user()->name }}
            </span>
