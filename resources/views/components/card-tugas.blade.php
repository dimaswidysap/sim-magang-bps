                    ...
                    <tr class="hover:bg-black/[0.02] transition-colors duration-200 group">
                        ...
                        <td class="px-5 py-4 align-middle">
                            <div class="flex items-center gap-3">
                                @if ($tugas->asn?->asnProfile?->avatar)
                                    <img src="{{ asset('storage/' . $tugas->asn->asnProfile->avatar) }}"
                                        alt="{{ $tugas->asn->name ?? 'ASN' }}"
                        ...
                        <td class="px-5 py-4 align-middle text-center">
                            <x-buttonv2 href="{{ route('detail-tugas', $tugas->id) }}" color="accent-dark"
