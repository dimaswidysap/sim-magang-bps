...
@php
    $baseClasses = 'font-montserrat self-center cursor-pointer inline-flex items-center border border-text/20 justify-center py-2 gap-2 px-4 rounded-md font-montserrat font-bold text-[12px]  transition-all duration-200 focus:outline-none';
