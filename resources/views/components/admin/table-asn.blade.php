...
<section class="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 font-montserrat">
    ...
    <x-buttonv2 href="{{ route('asn.mahasiswa.create') }}" color="accent-dark" class="w-full sm:w-auto">
    ...
    <div class="w-full">
        <table class="w-full text-left border-collapse">
            ...
            <thead class="hidden md:table-header-group bg-background/50 border-b border-border">
                <tr>
                    <th scope="col"
                        class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider text-center w-16">No
                    </th>
                    <th scope="col" class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider">Nama
                        Pegawai</th>
                    <th scope="col" class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider">NIP
                    </th>
                    <th scope="col" class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider">
                        Jabatan</th>
                    <th scope="col" class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider">Unit
                        Kerja</th>
                    <th scope="col"
                        class="px-6 py-4 text-xs font-bold text-text-light uppercase tracking-wider text-center">Aksi
                    </th>
                </tr>
            </thead>
                    ...
                    <tr
                        ...
                        <td class="block md:table-cell md:px-6 md:py-4 mb-2 md:mb-0">
                            <div class="flex justify-between items-center md:block">
                                ...
                                <span
                                    class="text-xs md:text-sm font-mono font-semibold text-primary-dark bg-primary/10 px-2.5 py-1 rounded-md border border-primary/20">
                                    {{ $asn->asnProfile->nip ?? '-' }}
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="block md:table-cell md:px-6 md:py-4 mb-4 md:mb-0">
                            <div class="flex justify-between items-center md:block">
                                <span class="md:hidden text-[10px] font-bold text-text-light uppercase">Unit
                                    Kerja:</span>
                    ...
                    <tr class="block md:table-row">
                        <td colspan="6" class="block md:table-cell px-6 py-12 md:py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-sm text-text-light mt-1">Data pegawai yang ditambahkan akan muncul di
                                    sini.</p>
                            </div>
                        </td>
                    </tr>
