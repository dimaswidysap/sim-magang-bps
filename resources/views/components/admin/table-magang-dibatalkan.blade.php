<div class="bg-surface border border-border rounded-xl shadow-sm overflow-hidden font-montserrat w-full">
    ...
    <!-- Header Tabel Peringatan (Status Dibatalkan) -->
    <div
        ...
        <div class="flex items-center gap-4">
            ...
            <!-- Icon Danger (X-Circle) -->
            <div
                class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-danger/10 text-danger flex items-center justify-center shrink-0 border border-danger/20">
            ...
            <div>
                <h2 class="text-base md:text-lg font-bold text-text leading-tight">
                    Perhatian: Status Magang Dibatalkan
                </h2>
                <p class="text-[11px] md:text-xs text-text-light mt-1">
                    Daftar mahasiswa yang pengajuan atau status magangnya telah dibatalkan.
                </p>
            </div>
    ...
    <div class="w-full">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="block md:table-row-group divide-y divide-border md:divide-y-0">
                @forelse ($jumlahMahasiswaBatal as $mhs)
