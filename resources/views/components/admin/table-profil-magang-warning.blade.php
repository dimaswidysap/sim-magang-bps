<div class="bg-surface border border-border rounded-xl shadow-sm overflow-hidden font-montserrat w-full">
    ...
    <div class="p-5 md:p-6 border-b border-border bg-background flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            <!-- Icon Warning -->
            <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-warning/10 text-warning flex items-center justify-center shrink-0 border border-warning/20">
            ...
            <div>
                <h2 class="text-base md:text-lg font-bold text-text leading-tight">Perhatian: Profil Belum Lengkap</h2>
                <p class="text-[11px] md:text-xs text-text-light mt-1">Daftar mahasiswa magang yang belum melengkapi data diri mereka di sistem.</p>
            </div>
        </div>
    </div>
                    ...
                    <tr class="block md:table-row flex-col p-4 md:p-0 hover:bg-primary/5 transition-colors duration-200 group md:border-b md:border-border last:border-b-0">
                        ...
                        <td class="block md:table-cell md:px-6 md:py-4 mb-3 md:mb-0">
                            <div class="flex items-center gap-3">
                                <!-- Avatar Inisial -->
                                <div class="w-10 h-10 md:w-9 md:h-9 rounded-full bg-primary/10 text-primary-dark flex items-center justify-center text-xs font-bold shrink-0 border border-primary/20">
                    ...
                    <tr class="block md:table-row">
                        ...
                        <td colspan="3" class="block md:table-cell px-6 py-12 md:py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                <div class="w-12 h-12 md:w-14 md:h-14 rounded-full bg-success/10 text-success flex items-center justify-center mb-3 md:mb-4 border border-success/20">
                                ...
                                <p class="text-sm md:text-base font-bold text-text">Semua Profil Telah Lengkap</p>
                                <p class="text-[11px] md:text-sm text-text-light mt-1 text-center">Saat ini tidak ada mahasiswa yang belum melengkapi data dirinya.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
