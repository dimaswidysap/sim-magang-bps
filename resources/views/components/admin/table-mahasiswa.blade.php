                            ...
                            <tr class="data-row block md:table-row flex-col p-4 md:p-0 hover:bg-primary/5 transition-colors duration-200 group md:border-b md:border-border last:border-b-0">
                                ...
                                <td class="block md:table-cell md:px-6 md:py-4 mb-2 md:mb-0">
                                    <div class="flex justify-between items-center md:block">
                                        <span class="md:hidden text-[10px] font-bold text-text-light uppercase">NIM:</span>
                                        <span class="text-xs font-mono text-primary-dark font-semibold bg-primary/10 border border-primary/20 px-2 py-1 rounded-md">
                                ...
                                <td class="block md:table-cell md:px-6 md:py-4 mb-4 md:mb-0">
                                    <div class="flex justify-between md:justify-start items-center gap-3">
                                        ...
                                        <div class="flex items-center gap-3">
                                            <!-- Avatar -->
                                            <div class="hidden md:flex w-9 h-9 rounded-full bg-primary/10 text-primary flex-shrink-0 items-center justify-center text-xs font-bold border border-primary/20">
                                ...
                                <td class="block md:table-cell md:px-6 md:py-4 mb-2 md:mb-0">
                                    <div class="flex justify-between items-center md:block">
                                        <span class="md:hidden text-[10px] font-bold text-text-light uppercase">Instansi:</span>
                                ...
                                <!-- Jurusan & Jenjang -->
                                <td class="block md:table-cell md:px-6 md:py-4 mb-2 md:mb-0">
                                    <div class="flex justify-between md:flex-col md:justify-center items-center md:items-start">
                                        <span class="md:hidden text-[10px] font-bold text-text-light uppercase">Jurusan:</span>
                                        <div class="text-right md:text-left">
                                            <p class="text-sm font-medium text-text">{{ $mhs->mahasiswaProfile->jurusan ?? '-' }}</p>
                                            <p class="text-[11px] text-text-light mt-0.5">({{ $mhs->mahasiswaProfile->jenjang ?? '-' }})</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="block md:table-cell md:px-6 md:py-4 mb-4 md:mb-0">
                                    <div class="flex justify-between items-center md:block">
                                        <span class="md:hidden text-[10px] font-bold text-text-light uppercase">Periode:</span>
                                        <div class="flex flex-col text-right md:text-left text-xs text-text-light">
                                            <span class="font-medium text-text">{{ $mhs->tanggal_mulai ? \Carbon\Carbon::parse($mhs->tanggal_mulai)->translatedFormat('d M Y') : '-' }}</span>
                                            <span class="text-[10px] my-0.5">s.d</span>
                                            <span class="font-medium text-text">{{ $mhs->tanggal_selesai ? \Carbon\Carbon::parse($mhs->tanggal_selesai)->translatedFormat('d M Y') : '-' }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="block md:table-cell md:px-6 md:py-4 md:text-center mt-2 md:mt-0">
                                    <div class="flex justify-between md:justify-center items-center">
                                        ...
                                        @if ($mhs->is_active)
                                            <span class="inline-flex px-3 py-1 bg-success/10 border border-success/20 text-success-dark text-xs font-bold rounded-full items-center gap-1.5 shadow-sm">
                                                <span class="w-1.5 h-1.5 rounded-full bg-success animate-pulse"></span>
                                                Aktif
                                            </span>
                                        @else
                                            <span class="inline-flex px-3 py-1 bg-danger/10 border border-danger/20 text-danger-dark text-xs font-bold rounded-full items-center gap-1.5 shadow-sm">
                                ...
                                <!-- Aksi -->
                                <td class="block md:table-cell md:px-6 md:py-4 md:text-center mt-4 md:mt-0 pt-4 md:pt-0 border-t border-border md:border-0">
                            ...
                            <tr class="block md:table-row">
                                <td colspan="7" class="block md:table-cell px-6 py-12 md:py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-text-light mt-1">Tambahkan data mahasiswa magang terlebih dahulu.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
