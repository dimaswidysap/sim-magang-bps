<section class="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 font-montserrat">
    ...
    <div class="bg-surface border border-border rounded-[10px] shadow-sm p-5 md:p-6 flex items-center gap-4 md:gap-6 hover:shadow-md transition-shadow duration-300">

        <!-- Ikon Mahasiswa -->
        <figure class="h-14 w-14 md:h-16 md:w-16 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 border border-primary/20">
        ...
        <div class="flex-1">
            ...
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <!-- Data Nonaktif -->
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-text leading-none">{{ $jumlahMahasiswaNonAktif }}</h2>
    ...
    <!-- Card Statistik ASN -->
    <div class="bg-surface border border-border rounded-2xl shadow-sm p-5 md:p-6 flex items-center gap-4 md:gap-6 hover:shadow-md transition-shadow duration-300">

        <!-- Ikon ASN / Pegawai -->
        <figure class="h-14 w-14 md:h-16 md:w-16 rounded-full bg-warning/10 text-warning-dark flex items-center justify-center shrink-0 border border-warning/20">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
