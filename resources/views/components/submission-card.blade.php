            ...
            @foreach ($tugasMenungguReview as $tugas)
                <div
                    ...
                    <div class="p-4 bg-background border-t border-border flex justify-end">
                        <x-main-button href="{{ route('asn-submission-detail', $tugas->id) }}"
                            class="bg-primary hover:bg-primary-dark text-xs px-4 py-2 rounded-lg text-white transition-colors shadow-sm inline-flex items-center gap-2 w-full justify-center sm:w-auto">
