...
{
    /**
     * Master data periode/batch magang.
     * Dipakai untuk membatasi masa aktif magang mahasiswa & validasi absensi.
     */
    public function up(): void
    {
        Schema::create('periode_magang', function (Blueprint $table) {
            $table->id();
            $table->string('nama_periode'); // contoh: "Periode Januari - Maret 2026"
